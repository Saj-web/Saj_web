...
if(isset($_POST['submit'])) {
    ...
    if($employee_id) {
        ...
        if($stmt->execute()) {
            ...
            header("Location: leave_hist.php" );
        }else {
...
<?php include 'templates/aside.php' ?>
    <div class="content">
            <div class="container-fluid mt-4">
                <h1 class="h3 mb-4 text-gray-800 text-center">Leave Form</h1>
                <form action="leave.php" method="post">
                <div class="form-group mb-3">
                    <label for="employee_name">Employee Name:</label>
                    <input type="text" id="employee_name" name="employee_name" value="<?php echo $employee_name; ?>"style="display:block;width: 100%;border: 0.5px solid green;padding:8px;border-radius:5px"readonly>
                </div>
                <div class="form-group mb-3">
